...
inventory = [
    ...
    ["Motivate",     0,                spr_priceUp,  1,           10,         10,            1,      1,         5],   // Short boost, affordable for early use
    ["Hire",         0,                spr_priceUp,  2,           20,         20,            1,      0,         10],  // Scales well with `global.acamount`
    ["Market",       0,                spr_priceUp,  3,           25,         25,            1,      0,         12],  // Boosts income, balanced cost
    ["Split",        0,                spr_priceUp,  4,           60,         60,            1,      0,         30],  // High impact, higher cost
    ["Fix Cage 10%", 0,                spr_priceUp,  5,           10,         10,            1,      0,         5],   // Early-game affordability
    ["Fix Cage 30%", 0,                spr_priceUp,  5,           25,         25,            1,      0,         10],  // Scaled price for mid-game
    ["Fix Cage 50%", 0,                spr_priceUp,  5,           50,         50,            1,      0,         15],  // Mid-tier repair, balanced
    ["Fix Cage 80%", 0,                spr_priceUp,  5,           75,         75,            1,      0,         20],  // Significant repair, premium cost
    ["Upgrade Cage", 0,                spr_priceUp,  1,           100,        100,           1,      0,         50],  // High-cost upgrade for lasting impact
    ["Pacify",       0,                spr_priceUp,  1,           10,         10,            1,      1,         5],   // Temporary effect, reasonable cost
    ["Upgrade Hires",0,                spr_priceUp,  1,           20,         20,            1,      0,         15]   // Long-term investment, adjusted to fairer scaling
];
hovered_slot = 0
mouseX = mouse_y
mouseY = mouse_x
