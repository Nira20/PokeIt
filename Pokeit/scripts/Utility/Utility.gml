...
draw_text_color(yes_x + button_width / 2, button_y + button_height / 2 - 10, string(t1), c_white, c_white, c_white, c_white, 1);

// Draw "No" button
draw_rectangle_color(no_x, button_y, no_x + button_width, button_y + button_height, c_red, c_red, c_red, c_red, false);
draw_text_color(no_x + button_width / 2, button_y + button_height / 2 - 10, string(t2), c_white, c_white, c_white, c_white, 1);
